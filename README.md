...
The relationship between the two tables is a one and only one to one or many.

2. What does the blue diamond next to the "last_update" column on the "inventory" table represent?

The blue diamond next to the last_update column represents the data is not null.
